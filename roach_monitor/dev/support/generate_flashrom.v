...
`define AV3 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV4 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV5 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
...
`define AV7 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV8 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV9 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
