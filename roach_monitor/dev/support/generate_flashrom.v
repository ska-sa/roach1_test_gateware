...
`define AV0 (`AV_SCALING_FACTOR_8V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV1 (`AV_SCALING_FACTOR_8V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV2 (`AV_SCALING_FACTOR_2V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV3 (`AV_SCALING_FACTOR_2V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV4 (`AV_SCALING_FACTOR_8V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV5 (`AV_SCALING_FACTOR_1V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV6 (`AV_SCALING_FACTOR_8V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV7 (`AV_SCALING_FACTOR_8V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV8 (`AV_SCALING_FACTOR_2V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV9 (`AV_SCALING_FACTOR_1V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
...
`define AC3 (`AC_SCALING_FACTOR_16V | `AC_ANALOG_MUX_SELECT_PRESCALER | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_OPERATIONAL)
`define AC4 (`AC_SCALING_FACTOR_16V | `AC_ANALOG_MUX_SELECT_PRESCALER | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_OPERATIONAL)
`define AC5 (`AC_SCALING_FACTOR_16V | `AC_ANALOG_MUX_SELECT_PRESCALER | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_OPERATIONAL)
...
`define AC7 (`AC_SCALING_FACTOR_16V | `AC_ANALOG_MUX_SELECT_PRESCALER | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_OPERATIONAL)
`define AC8 (`AC_SCALING_FACTOR_16V | `AC_ANALOG_MUX_SELECT_PRESCALER | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_OPERATIONAL)
`define AC9 (`AC_SCALING_FACTOR_16V | `AC_ANALOG_MUX_SELECT_PRESCALER | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_OPERATIONAL)


`define AT0 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_PRESCALER | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_OPERATIONAL)
`define AT1 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_PRESCALER | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_OPERATIONAL)
`define AT2 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_PRESCALER | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_OPERATIONAL)
