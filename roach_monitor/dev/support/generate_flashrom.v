...
`define AG1 (`AG_CHIP_TEMP_MONITOR_ON | `AG_CURRENT_DRIVE_1UA | `AG_POLARITY_POSITIVE | `AG_DRIVER_MODE_HIGH)
`define AG2 (`AG_CHIP_TEMP_MONITOR_ON | `AG_CURRENT_DRIVE_1UA | `AG_POLARITY_POSITIVE | `AG_DRIVER_MODE_HIGH)
`define AG3 (`AG_CHIP_TEMP_MONITOR_ON | `AG_CURRENT_DRIVE_1UA | `AG_POLARITY_POSITIVE | `AG_DRIVER_MODE_HIGH)
`define AG4 (`AG_CHIP_TEMP_MONITOR_ON | `AG_CURRENT_DRIVE_1UA | `AG_POLARITY_POSITIVE | `AG_DRIVER_MODE_HIGH)
`define AG5 (`AG_CHIP_TEMP_MONITOR_ON | `AG_CURRENT_DRIVE_1UA | `AG_POLARITY_POSITIVE | `AG_DRIVER_MODE_HIGH)
`define AG6 (`AG_CHIP_TEMP_MONITOR_ON | `AG_CURRENT_DRIVE_1UA | `AG_POLARITY_POSITIVE | `AG_DRIVER_MODE_HIGH)
`define AG7 (`AG_CHIP_TEMP_MONITOR_ON | `AG_CURRENT_DRIVE_1UA | `AG_POLARITY_POSITIVE | `AG_DRIVER_MODE_HIGH)
`define AG8 (`AG_CHIP_TEMP_MONITOR_ON | `AG_CURRENT_DRIVE_1UA | `AG_POLARITY_POSITIVE | `AG_DRIVER_MODE_HIGH)
`define AG9 (`AG_CHIP_TEMP_MONITOR_ON | `AG_CURRENT_DRIVE_1UA | `AG_POLARITY_POSITIVE | `AG_DRIVER_MODE_HIGH)
...
`define AC0 (`AC_SCALING_FACTOR_16V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
`define AC1 (`AC_SCALING_FACTOR_16V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
`define AC2 (`AC_SCALING_FACTOR_16V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
...
`define AC6 (`AC_SCALING_FACTOR_16V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
...
`define AT1 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_TEMPMON | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
`define AT2 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_TEMPMON | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
`define AT3 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_TEMPMON | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
`define AT4 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_TEMPMON | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
`define AT5 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_TEMPMON | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
`define AT6 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_TEMPMON | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
`define AT7 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_TEMPMON | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
`define AT8 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_TEMPMON | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
`define AT9 (`AT_SCALING_FACTOR_16V | `AT_ANALOG_MUX_SELECT_TEMPMON | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
