...
`define AV0_HIGH      8'd120
`define AV0_LOW       8'd8
`define AV1_HIGH      8'd255
`define AV1_LOW       8'd0
`define AV2_HIGH      8'd255
`define AV2_LOW       8'd0
`define AV3_HIGH      8'd255
`define AV3_LOW       8'd0
`define AV4_HIGH      8'd255
`define AV4_LOW       8'd0
`define AV5_HIGH      8'd255
`define AV5_LOW       8'd0
`define AV6_HIGH      8'd255
`define AV6_LOW       8'd0
`define AV7_HIGH      8'd255
`define AV7_LOW       8'd0
`define AV8_HIGH      8'd255
`define AV8_LOW       8'd0
`define AV9_HIGH      8'd255
`define AV9_LOW       8'd0
...
`define AT0_HIGH      8'd255
`define AT0_LOW       8'd0
`define AT1_HIGH      8'd255
`define AT1_LOW       8'd0
`define AT2_HIGH      8'd255
`define AT2_LOW       8'd0
...
`define AG0 (`AG_CHIP_TEMP_MONITOR_OFF | `AG_CURRENT_DRIVE_1UA | `AG_POLARITY_POSITIVE | `AG_DRIVER_MODE_HIGH)
...
`define AV0 (`AV_SCALING_FACTOR_8V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV1 (`AV_SCALING_FACTOR_8V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV2 (`AV_SCALING_FACTOR_2V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV3 (`AV_SCALING_FACTOR_2V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV4 (`AV_SCALING_FACTOR_8V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV5 (`AV_SCALING_FACTOR_1V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV6 (`AV_SCALING_FACTOR_8V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV7 (`AV_SCALING_FACTOR_8V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV8 (`AV_SCALING_FACTOR_2V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV9 (`AV_SCALING_FACTOR_1V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)

`define AC0 (`AC_SCALING_FACTOR_8V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
`define AC1 (`AC_SCALING_FACTOR_8V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
`define AC2 (`AC_SCALING_FACTOR_8V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
`define AC3 (`AC_SCALING_FACTOR_8V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
`define AC4 (`AC_SCALING_FACTOR_8V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
`define AC5 (`AC_SCALING_FACTOR_8V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
`define AC6 (`AC_SCALING_FACTOR_8V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
`define AC7 (`AC_SCALING_FACTOR_8V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
`define AC8 (`AC_SCALING_FACTOR_8V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)
`define AC9 (`AC_SCALING_FACTOR_8V | `AC_ANALOG_MUX_SELECT_CURRENTAMP | `AC_DIRECT_ANALOG_INPUT_OFF | `AC_PAD_POLARITY_POSITIVE | `AC_PRESCALER_MODE_POWERDOWN)


`define AT0 (`AT_SCALING_FACTOR_8V | `AT_ANALOG_MUX_SELECT_PRESCALER | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_OPERATIONAL)
`define AT1 (`AT_SCALING_FACTOR_8V | `AT_ANALOG_MUX_SELECT_PRESCALER | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_OPERATIONAL)
`define AT2 (`AT_SCALING_FACTOR_8V | `AT_ANALOG_MUX_SELECT_TEMPMON   | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
`define AT3 (`AT_SCALING_FACTOR_8V | `AT_ANALOG_MUX_SELECT_TEMPMON   | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
`define AT4 (`AT_SCALING_FACTOR_8V | `AT_ANALOG_MUX_SELECT_PRESCALER | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_OPERATIONAL)
`define AT5 (`AT_SCALING_FACTOR_8V | `AT_ANALOG_MUX_SELECT_PRESCALER | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_OPERATIONAL)
`define AT6 (`AT_SCALING_FACTOR_8V | `AT_ANALOG_MUX_SELECT_TEMPMON   | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
`define AT7 (`AT_SCALING_FACTOR_8V | `AT_ANALOG_MUX_SELECT_TEMPMON   | `AT_DIRECT_ANALOG_INPUT_OFF | `AT_PRESCALER_MODE_POWERDOWN)
