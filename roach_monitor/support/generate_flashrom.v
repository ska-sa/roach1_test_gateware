...
`define AV5_HIGH      8'd144
`define AV5_LOW       8'd100
`define AV6_HIGH      8'd255
`define AV6_LOW       8'd0
`define AV7_HIGH      8'd206
`define AV7_LOW       8'd162
`define AV8_HIGH      8'd132
`define AV8_LOW       8'd93
`define AV9_HIGH      8'd166
`define AV9_LOW       8'd140
...
`define AV2 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_OFF | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV3 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV4 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV5 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
...
`define AV7 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV8 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV9 (`AV_SCALING_FACTOR_16V | `AV_ANALOG_MUX_SELECT_PRESCALER | `AV_CURRENT_MON_SWITCH_ON | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
