...
`define AV5 (`AV_SCALING_FACTOR_2V  | `AV_ANALOG_MUX_SELECT_DIRECT    | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
...
`define AV7 (`AV_SCALING_FACTOR_2V  | `AV_ANALOG_MUX_SELECT_DIRECT    | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
`define AV8 (`AV_SCALING_FACTOR_4V  | `AV_ANALOG_MUX_SELECT_DIRECT    | `AV_CURRENT_MON_SWITCH_ON  | `AV_DIRECT_ANALOG_INPUT_OFF | `AV_PAD_POLARITY_POSITIVE | `AV_PRESCALER_MODE_OPERATIONAL)
